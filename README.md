...
1. Бот возвращает цену на определённое количество валюты из списка доступных к конвертации валют в Боте (евро, доллар или рубль).
2. При написании бота необходимо использовать библиотеку pytelegrambotapi.
3. Человек должен отправить сообщение боту в виде <имя валюты цену которой он хочет узнать> <имя валюты в которой надо узнать цену первой валюты> <количество первой валюты>. 

***Изменила порядок - сначала сумма, затем валюта, затем валюта в которую пересчитать сумму первой валюты.
